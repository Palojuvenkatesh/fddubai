...
export function Signup(){
    ...
    const registerTheUser = async () => {
        ...
        const url = "http://localhost:5050/auth/signup-user";
        const options = {
            method: "POST",
            headers: {
...
//                 password: "",
//                 passwordRequiredText:
//                     "Password must be greater than 5 characters and less than or equal
// to 10 characters"
// }));
setPasswordText((prevState) => ({
    ...prevState,                  // Spread the previous state to preserve other state properties
    password: "",                  // Reset the password field to an empty string
    passwordRequiredText: "Password must be greater than 5 characters and less than or equal to 10 characters"
}));
        ...
        <div className="signup-form-card shadow">
            <div className="signup-logo-image-container">
                <img
                    ...
                    src="https://cdn.pixabay.com/photo/2017/03/16/21/18/logo-
2150297_640.png"
...
text">{emailText.emailRequiredText}</p>
